...
@Component({
  ...
  imports: [
    ...
    PhotoPickerComponent, ExteriorGalleryComponent, StyleSelectorComponent,
...
export class ExteriorDesignPage {
  ...
  constructor(
    ...
    addIcons({ sparklesOutline, flashOutline, arrowBackOutline, chevronForwardOutline, chevronBackOutline, checkmarkOutline, businessOutline, cameraOutline });
  }
