...
@Component({
  ...
  imports: [
    ...
    PhotoPickerComponent, StyleSelectorComponent,
    ResultActionsComponent, AiLoaderComponent, TranslatePipe,
  ],
  templateUrl: './flooring.page.html',
  styleUrls: ['./flooring.page.scss'],
})
export class FlooringPage {
  @ViewChild(IonContent, { static: false }) private content!: IonContent;

  readonly floorStyles = FLOOR_STYLES;
  readonly palettes = COLOR_PALETTES;

  readonly steps: WizardStep[] = [
    { id: 'room',    labelKey: 'home.room_space',    required: true  },
    { id: 'style',   labelKey: 'flooring.title',     required: true  },
    ...
    try {
      ...
      this.generation.surfaceEdit({
        ...
        next: (res) => {
          ...
          this.toast.success('Floor design ready!');
        },
        error: (err) => {
